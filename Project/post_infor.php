            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><a type="button" value="แก้ไข" name="btn-edit" class="btn btn-primary" href="edit_form.php?update_id=<?php echo $row['id']; ?>">แก้ไข</td>
                        <td><a type="button" value="ลบ" name="btn-delete" class="btn btn-danger" href="?delete_id=<?php echo $row['id']; ?>">ลบ</td>                       
                    </tr>
                <?php } ?>
            </tbody>
        </table>
    ...
    <script>
        function delete_id(id) {
            if (confirm("Are you sure to delete this recoed?")) {
                window.location.href = "post_infor.php?id=" + id;
            }
        }
